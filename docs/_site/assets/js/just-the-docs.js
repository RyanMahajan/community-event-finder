...
function initSearch() {
  ...
  request.open('GET', '/community-event-finder/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/community-event-finder/assets/css/just-the-docs-' + theme + '.css');
}
